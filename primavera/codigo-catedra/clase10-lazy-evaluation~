...
(define (eval expr env)
  (match expr
    ...
    [(add l r) (addV (eval l env) (eval r env))]
    [(sub l r) (subV (eval l env) (eval r env))]
    [(if0 c t f) (if (num-zero? (eval c env))(eval t env) (eval f env))]
    [(app f e)  (def (closureV farg fbody fenv) (eval f env))
                (eval fbody (extend-env farg (eval e env) fenv))]
